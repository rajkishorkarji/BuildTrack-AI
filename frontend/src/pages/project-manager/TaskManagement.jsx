...
import { CheckSquare, Plus, Search, RefreshCw, AlertTriangle, Users, Calendar, Clock, CheckCircle2, X } from 'lucide-react';
      ...
      <div className="panel" style={{ marginTop: 14, padding: 0, overflow: 'hidden' }}>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {loading && (
                <tr><td colSpan={7} style={{ padding: 40, textAlign: 'center', color: 'var(--muted)' }}>Loading tasks...</td></tr>
              )}
