...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        applyRolePermissions(superAdminRole, permissions, Set.of(
                "DASHBOARD_VIEW","PROJECT_VIEW","PROJECT_MANAGE","TASK_MANAGE","WORKFORCE_VIEW","WORKFORCE_MANAGE",
                "ATTENDANCE_MARK","SHIFT_MANAGE","EQUIPMENT_VIEW","EQUIPMENT_MANAGE","FINANCE_VIEW","FINANCE_MANAGE",
                "AI_VIEW","REPORT_VIEW","DOCUMENT_VIEW","DOCUMENT_MANAGE","NOTIFICATION_VIEW","COMPANY_ADMIN_MANAGE",
                "SYSTEM_ADMIN_MANAGE","PROFILE_EDIT"));
        applyRolePermissions(companyAdminRole, permissions, Set.of(
                "DASHBOARD_VIEW","PROJECT_VIEW","PROJECT_MANAGE","TASK_MANAGE","WORKFORCE_VIEW","WORKFORCE_MANAGE",
                "ATTENDANCE_MARK","SHIFT_MANAGE","EQUIPMENT_VIEW","EQUIPMENT_MANAGE","FINANCE_VIEW","FINANCE_MANAGE",
                "AI_VIEW","REPORT_VIEW","DOCUMENT_VIEW","DOCUMENT_MANAGE","NOTIFICATION_VIEW","COMPANY_ADMIN_MANAGE","PROFILE_EDIT"));
        applyRolePermissions(projectManagerRole, permissions, Set.of(
                "DASHBOARD_VIEW","PROJECT_VIEW","PROJECT_MANAGE","TASK_MANAGE","WORKFORCE_VIEW","WORKFORCE_MANAGE",
                "ATTENDANCE_MARK","SHIFT_MANAGE","EQUIPMENT_VIEW","EQUIPMENT_MANAGE","FINANCE_VIEW","AI_VIEW","REPORT_VIEW",
                "DOCUMENT_VIEW","DOCUMENT_MANAGE","NOTIFICATION_VIEW","PROFILE_EDIT"));
        applyRolePermissions(siteEngineerRole, permissions, Set.of(
                "DASHBOARD_VIEW","PROJECT_VIEW","TASK_MANAGE","WORKFORCE_VIEW","WORKFORCE_MANAGE","ATTENDANCE_MARK","SHIFT_MANAGE",
                "EQUIPMENT_VIEW","EQUIPMENT_MANAGE","DOCUMENT_VIEW","DOCUMENT_MANAGE","NOTIFICATION_VIEW","PROFILE_EDIT"));
        applyRolePermissions(contractorRole, permissions, Set.of(
                "DASHBOARD_VIEW","PROJECT_VIEW","TASK_MANAGE","WORKFORCE_VIEW","WORKFORCE_MANAGE","ATTENDANCE_MARK","SHIFT_MANAGE",
                "FINANCE_VIEW","DOCUMENT_VIEW","NOTIFICATION_VIEW","PROFILE_EDIT"));
        applyRolePermissions(workerRole, permissions, Set.of(
                "DASHBOARD_VIEW","PROJECT_VIEW","TASK_MANAGE","EQUIPMENT_VIEW","WORKFORCE_VIEW","ATTENDANCE_MARK","DOCUMENT_VIEW",
